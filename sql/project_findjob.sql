...
CREATE TABLE IF NOT EXISTS `chat` (
  ...
  `readchat` bit(1) DEFAULT b'0',
  `chatListId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_chat_user` (`toName`) USING BTREE,
  KEY `FK_chat_user_2` (`fromName`) USING BTREE,
  KEY `FK_chat_chatlist` (`chatListId`),
  CONSTRAINT `FK_chat_chatlist` FOREIGN KEY (`chatListId`) REFERENCES `chatlist` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- 테이블 데이터 project.chat:~35 rows (대략적) 내보내기
INSERT INTO `chat` (`id`, `toName`, `fromName`, `data`, `time`, `readchat`, `chatListId`) VALUES
	(25, '김우식', '송강', '안녕하세요', '2024-03-04 06:31:03', b'1', 1),
	(26, '김우식', '송강', '반갑습니다.', '2024-03-04 06:31:10', b'1', 1),
	(27, '송강', '김우식', '네 안녕하세요~', '2024-03-04 06:32:17', b'1', 1),
	(33, '송강', '김우식', '네네', '2024-03-04 06:51:54', b'1', 1),
	(34, '김우식', '송강', '언제부터 출근 가능하신가요?', '2024-03-04 06:54:04', b'1', 1),
	(88, '이지은', '송강', '안녕하세요~', '2024-03-05 01:04:20', b'1', 6),
	(89, '조보아', '송강', '안녕하세요~ 이력서보고 연락드립니다!', '2024-03-05 01:12:19', b'1', 11),
	(90, '조보아', '송강', '현재 주말 직원 모집중입니다.', '2024-03-05 01:13:21', b'1', 11),
	(91, '이지은', '송강', 'gd', '2024-03-05 01:37:29', b'1', 6),
	(92, '이지은', '송강', 'dgd', '2024-03-05 01:48:34', b'1', 6),
	(93, '이지은', '송강', 'gd', '2024-03-05 01:57:21', b'1', 6),
	(94, '이지은', '송강', 'sp', '2024-03-05 01:58:36', b'1', 6),
	(95, '이지은', '송강', '안녕하세요. 이력서보고 연락드립니다.', '2024-03-05 02:45:59', b'1', 6),
	(96, '차은우', '송강', '안녕하세요! 근무가능하신 시간대가 어떻게 되시나요?', '2024-03-05 02:46:37', b'0', 12),
	(97, '김우식', '송강', '시간나실때 전화 부탁드립니다~', '2024-03-05 02:49:26', b'0', 1),
	(98, '이지은', '송강', '안녕하세요!', '2024-03-05 03:11:28', b'1', 6),
	(99, '송강', '이지은', '네 안녕하세요.', '2024-03-05 03:11:58', b'1', 6),
	(100, '송강', '이지은', 'zzz', '2024-03-05 03:13:14', b'1', 6),
	(101, '이지은', '송강', '반갑습니다.', '2024-03-05 03:13:23', b'1', 6),
	(102, '송강', '이지은', '시간대가 언제쯤 괜찮으신가요?', '2024-03-05 03:13:55', b'1', 6),
	(103, '송강', '이지은', '오늘 오후쯤요', '2024-03-05 03:14:36', b'1', 6),
	(104, '이지은', '송강', '4시쯤 어떠세요?', '2024-03-05 03:15:01', b'1', 6),
	(105, '송강', '이지은', '좋아요', '2024-03-05 03:15:28', b'1', 6),
	(106, '이지은', '송강', '그래요', '2024-03-05 03:15:41', b'1', 6),
	(107, '송강', '이지은', '네', '2024-03-05 03:16:11', b'1', 6),
	(108, '이지은', '송강', 'ㅋㅋ', '2024-03-05 03:17:47', b'1', 6),
	(109, '송강', '이지은', '그래요', '2024-03-05 03:17:51', b'1', 6),
	(110, '조보아', '송강', '안녕하세요.', '2024-03-05 03:23:12', b'0', 11),
	(111, '송강', '조보아', '네 안녕하세요~', '2024-03-05 03:23:18', b'1', 11),
	(112, '이지은', '송강', '안녕하세요', '2024-03-05 03:29:16', b'1', 6),
	(113, '송강', '이지은', '네 안녕하세요', '2024-03-05 03:29:23', b'1', 6),
	(114, '조보아', '송강', '반갑습니다!', '2024-03-05 03:30:46', b'0', 11),
	(115, '이지은', '송강', '반갑습니다!', '2024-03-05 03:31:15', b'1', 6),
	(116, '송강', '이지은', '네~~', '2024-03-05 03:32:12', b'1', 6),
	(117, '이지은', '송강', '안녕하세요!', '2024-03-05 03:33:32', b'1', 6),
	(118, '이지은', '송강', '안녕', '2024-03-05 03:34:49', b'1', 6),
	(119, '송강', '이지은', '네 안녕하세요', '2024-03-05 03:35:04', b'0', 6);

-- 테이블 project.chatlist 구조 내보내기
CREATE TABLE IF NOT EXISTS `chatlist` (
  ...
  `lastchat` varchar(50) DEFAULT NULL,
  `time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_chatlist_employment` (`fromName`),
  KEY `FK_chatlist_employment_2` (`employId`),
  CONSTRAINT `FK_chatlist_employment` FOREIGN KEY (`fromName`) REFERENCES `employment` (`ownername`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_chatlist_employment_2` FOREIGN KEY (`employId`) REFERENCES `employment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- 테이블 데이터 project.chatlist:~4 rows (대략적) 내보내기
INSERT INTO `chatlist` (`id`, `toName`, `fromName`, `employId`, `lastchat`, `time`) VALUES
	(1, '김우식', '송강', 7, '시간나실때 전화 부탁드립니다~', '2024-03-05 11:49:26'),
	(6, '이지은', '송강', 7, '네 안녕하세요', '2024-03-05 12:35:04'),
	(11, '조보아', '송강', 7, '반갑습니다!', '2024-03-05 12:30:46'),
	(12, '차은우', '송강', 7, '안녕하세요! 근무가능하신 시간대가 어떻게 되시나요?', '2024-03-05 11:46:37');
...
INSERT INTO `employment` (`id`, `storeid`, `storename`, `ownerid`, `job`, `ownername`, `phone`, `title`, `content`, `uploaddate`, `pay`, `pay_type`, `start_time`, `end_time`, `time`, `location`, `area1`, `area2`, `storeimg`, `deadline`, `status`) VALUES
	...
	(28, 25, '스타벅스 부산역점', 'owner123', 3, '김철민', '051-123-4423', '스타벅스에서 가족을 모집합니다.', '스타벅스에서 가족을 모집합니다.', '2024-03-05', 10000, 'hour', '09:00', '18:00', 'weekday', '부산 연제구 거제대로 128-9', '부산', '연제구', 'owner1231.jpg', '2024-03-30', 'ing'),
	(29, 29, '스타벅스 교대본점', 'sajang1234', 3, '홍정원', '051-665-4452', '스타벅스 교대본점 직원모집', '스타벅스 교대본점 직원모집', '2024-03-05', 10000, 'hour', '10:00', '17:00', 'weekday', '부산 강서구 가락대로 394', '부산', '강서구', 'sajang12341.jpg', '2024-03-30', 'ing'),
	(30, 30, '스타벅스 해운대점', 'tkwkd1', 1, '김연욱', '051-412-4103', '스타벅스 해운대점 직원모집', '스타벅스 해운대점 직원모집', '2024-03-05', 10000, 'hour', '09:00', '18:00', 'weekday', '부산 해운대구 구남로 15', '부산', '해운대구', 'tkwkd11.jpg', '2024-03-30', 'ing');
...
-- 테이블 데이터 project.employment_personality:~69 rows (대략적) 내보내기
...
-- 테이블 데이터 project.job:~13 rows (대략적) 내보내기
...
INSERT INTO `oauth2_authorized_client` (`client_registration_id`, `principal_name`, `access_token_type`, `access_token_value`, `access_token_issued_at`, `access_token_expires_at`, `access_token_scopes`, `refresh_token_value`, `refresh_token_issued_at`, `created_at`) VALUES
	('naver', '윤한민', 'Bearer', _binary 0x414141414f6d7938684e533134733653546e5334496831725278476634417570434469344d6842374f512d665949492d774d5178697a576f493856554448636a5138395f735951474d59547479545157316e356345524c43566e51, '2024-03-05 03:24:59', '2024-03-05 04:24:59', NULL, _binary , '2024-03-05 03:24:59', '2024-03-05 03:24:59');
...
-- 테이블 데이터 project.resume:~6 rows (대략적) 내보내기
INSERT INTO `resume` (`id`, `profile_img`, `userid`, `username`, `education`, `degree`, `score`, `liketime`, `description`, `loc`, `birthday`, `gender`, `phone`) VALUES
	...
	(29, 'user.png', 'user', '이지은', '전문대(2·3년제) 졸업', '사회복지학과', NULL, '2,1,1,3,2,1,1', '안녕하세요.', '연제구', '1997-02-19', 'F', '010-1569-7505');
...
-- 테이블 데이터 project.resume_job:~25 rows (대략적) 내보내기
...
-- 테이블 데이터 project.resume_personality:~35 rows (대략적) 내보내기
...
-- 테이블 데이터 project.store:~19 rows (대략적) 내보내기
INSERT INTO `store` (`id`, `userid`, `storename`, `job`, `address`, `storeimg1`, `storeimg2`, `storeimg3`, `phone`, `area1`, `area2`) VALUES
	...
	(25, 'owner123', '스타벅스 부산역점', 1, '부산 연제구 거제대로 128-9', 'owner1231.jpg', 'owner1232.jpg', 'owner1233.jpg', '051-123-4423', '부산', '연제구'),
	(26, 'owner1234', '스타벅스 연제점', 1, '부산 연제구 거제대로 120', 'owner12341.jpg', 'owner12342.jpg', 'owner12343.jpg', '051-513-5431', '부산', '연제구'),
	(29, 'sajang1234', '스타벅스 교대본점', 1, '부산 강서구 가락대로 394', 'sajang12341.jpg', 'sajang12342.jpg', 'sajang12343.jpg', '051-665-4452', '부산', '강서구'),
	(30, 'tkwkd1', '스타벅스 해운대점', 1, '부산 해운대구 구남로 15', 'tkwkd11.jpg', 'tkwkd12.jpg', 'tkwkd13.jpg', '051-412-4103', '부산', '해운대구');
...
-- 테이블 데이터 project.user:~29 rows (대략적) 내보내기
INSERT INTO `user` (`id`, `userid`, `useremail`, `uname`, `password`, `phone`, `birthday`, `address`, `enabled`, `type`, `gender`, `profileurl`, `social`, `area1`, `area2`) VALUES
	...
	(43, 'owner123', 'min@min.com', '김철민', '$2a$10$hCoExBeNPvUrRkFmssPGQeY3c7fl.5hDIkpADKkZZwvifTrvuiU2y', '010-1123-1234', '1980-02-13', '부산 해운대구 APEC로 58', b'1', 'owner', 'M', 'default.jpg', b'0', '부산', '해운대구'),
	(45, 'owner1234', 'min@min.com', '강현욱', '$2a$10$VpX/MAHnBwBGhHRxRP8LHOtGh1PIOu7iSEDWLUZAOmCDLEDP4YKui', '010-5548-4546', '2011-06-15', '부산 해운대구 APEC로 17', b'1', 'owner', 'M', 'default.jpg', b'0', '부산', '해운대구'),
	(47, 'sajang123', 'min@min.com', '강철진', '$2a$10$zfMD0TFn31jQPSSvlq1gOOJ4kba8a3rLlX.EJT0yRYL33iodHkB2K', '010-1156-5498', '1968-05-23', '부산 해운대구 구남로 9', b'0', 'owner', 'M', 'default.jpg', b'0', '부산', '해운대구'),
	(49, 'sajang1234', 'min@min.com', '홍정원', '$2a$10$snWRIh.CFRghBq7ubpu1BeDguAG8D3/mXuw9jNG65gh.UlT4ez.u2', '010-4451-4453', '1987-08-12', '부산 해운대구 구남로 11-2', b'1', 'owner', 'M', 'default.jpg', b'0', '부산', '해운대구'),
	(51, 'gksals8473', 'gksals8473@naver.com', '윤한민', NULL, NULL, NULL, NULL, b'0', NULL, 'M', 'default.jpg', b'1', NULL, NULL),
	(52, 'tkwkd1', 'min@min.com', '김연욱', '$2a$10$/JE095TVmmV2kPrXCXSAQu38szWpuAsTkkDPzLVAaNBGck7Zy0jlW', '010-4123-0155', '1974-05-05', '부산 해운대구 구남로 11', b'1', 'owner', 'M', 'default.jpg', b'0', '부산', '해운대구');
...
CREATE TABLE IF NOT EXISTS `user_role` (
  ...
  CONSTRAINT `FK2_role_id` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- 테이블 데이터 project.user_role:~29 rows (대략적) 내보내기
